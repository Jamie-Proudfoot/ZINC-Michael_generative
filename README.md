...
Current focus is on Michael acceptors from the ZINC-20 dataset.
...
#
See also the `chemical_vae` repository on property-dependent (conditional) generation using a two-head VAE.  
